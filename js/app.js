...
async function scrapeNow() {
    ...
    try {
        ...
        const response = await fetch('https://singapore-news-github-fgch78wvz-djyalus-projects.vercel.app/api/trigger-scraping', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            }
...
async function startScrapingStatusMonitor() {
    ...
    const checkStatus = async () => {
        ...
        try {
            const response = await fetch('https://singapore-news-github-fgch78wvz-djyalus-projects.vercel.app/api/get-scraping-status');
            const result = await response.json();
